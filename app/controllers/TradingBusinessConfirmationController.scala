...
class TradingBusinessConfirmationController @Inject() (
  ...
  formProvider:              TradingBusinessConfirmationFormProvider,
  val controllerComponents:  MessagesControllerComponents,
  view:                      TradingBusinessConfirmationView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData) { implicit request =>
    val preparedForm = request.userAnswers.get(TradingBusinessConfirmationPage) match {
      case None        => form
