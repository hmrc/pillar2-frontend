...
class AmendSubscriptionNavigator @Inject() {
  ...
  private val checkRouteMap: Page => UserAnswers => Call = {
    ...
    case SubSecondaryContactNamePage     => _ => contactDetailCheckYourAnswersRoute
    case SubSecondaryEmailPage           => _ => contactDetailCheckYourAnswersRoute
  ...
  def nextPage(page: Page, mode: Mode, userAnswers: UserAnswers): Call = mode match {
    ...
    case _ => contactDetailCheckYourAnswersRoute
  }
}
