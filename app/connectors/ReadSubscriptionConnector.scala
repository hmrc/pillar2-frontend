...
//      }
//      .recover { case e =>
//        println(s"[Session ID: ${Pillar2SessionKeys.sessionId(hc)}] - Error when calling read subscription: ${e.getMessage}")
//        throw e // Re-throw the exception so it can be handled in recoverWith
//      }
//      .recoverWith {
