...
trait AllMocks extends MockitoSugar { me: BeforeAndAfterEach =>
  ...
  val mockAccountActivityConnector:                   AccountActivityConnector                   = mock[AccountActivityConnector]
  val mockAccountActivityService:                     AccountActivityService                     = mock[AccountActivityService]
