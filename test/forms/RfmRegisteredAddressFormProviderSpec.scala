...
class RfmRegisteredAddressFormProviderSpec extends StringFieldBehaviours {

  val form                               = new RfmRegisteredAddressFormProvider()()
  ...
  ".addressLine1" - {
    ...
    val REQUIRED_KEY = "rfm.registeredAddress.error.addressLine1.required"
    val LENGTH_KEY   = "rfm.registeredAddress.error.addressLine1.length"
  ...
  ".addressLine2" - {
    ...
    val LENGTH_KEY = "rfm.registeredAddress.error.addressLine2.length"
  ...
  ".addressLine3" - {
    ...
    val REQUIRED_KEY = "rfm.registeredAddress.town_city.error.required"
    val LENGTH_KEY   = "rfm.registeredAddress.town_city.error.length"
    val XSS_KEY      = "addressLine.error.xss"
    behave like fieldThatBindsValidData(
      form,
      FIELD_NAME,
  ...
  ".addressLine4" - {
    ...
    val LENGTH_KEY = "rfm.registeredAddress.region.error.length"
    val XSS_KEY    = "addressLine.error.xss"
    behave like fieldThatBindsValidData(
      form,
      FIELD_NAME,
  ...
  ".postalCode" - {
    ...
    "test unbind with empty postcode" in {
  ...
  ".countryCode" - {
    ...
    val REQUIRED_KEY = "rfm.registeredAddress.country.error.required"
    val LENGTH_KEY   = "rfm.registeredAddress.country.error.length"
