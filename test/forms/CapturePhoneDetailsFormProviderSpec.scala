...
class CapturePhoneDetailsFormProviderSpec extends StringFieldBehaviours {

  val requiredKey = "capturePhoneDetails.error.required"
  val lengthKey   = "capturePhoneDetails.messages.error.length"
  val formatKey   = "capturePhoneDetails.messages.error.format"
  val maxLength   = 24
  ...
  val form = new CapturePhoneDetailsFormProvider()("test-user")
