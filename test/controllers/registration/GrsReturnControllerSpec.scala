  ...
  "GrsReturn Controller" must {
    ...
    "return 303 redirect to the next page with UK Limited company for UPE" in {
      ...
      running(application) {
        ...
        when(mockIncorporatedEntityIdentificationFrontendConnector.getJourneyData(any[String]())(any[HeaderCarrier]()))
    ...
    "return 303 redirect to the next page with Limited Liability Partnership for UPE" in {
      ...
      running(application) {
        ...
        when(mockPartnershipIdentificationFrontendConnector.getJourneyData(any[String]())(any[HeaderCarrier]()))
