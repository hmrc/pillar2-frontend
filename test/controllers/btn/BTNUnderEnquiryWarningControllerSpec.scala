...
class BTNUnderEnquiryWarningControllerSpec extends SpecBase {

  "BTNUnderEnquiryWarningController" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, routes.BTNUnderEnquiryWarningController.onPageLoad.url)
    ...
    "redirect to waiting room on POST" in {
      ...
      running(application) {
        val request = FakeRequest(POST, routes.BTNUnderEnquiryWarningController.onSubmit.url)
