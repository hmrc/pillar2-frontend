...
class BTNEntitiesInsideOutsideUKControllerSpec extends SpecBase with MockitoSugar {
  ...
  "EntitiesBothInUKAndOutsideController" should {
    ...
    "return OK and the correct view for amend group details page" in {
    ...
    "redirect to dashboard for onPageLoadAmendGroupDetails when phase2ScreensEnabled is false" in {
