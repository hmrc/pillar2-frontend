  ...
  "Not Confirmed Bank Details" must {
    ...
    "must return the correct view if the feature flag is true" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(NormalMode)(request, appConfig(), messages(application)).toString
      }
    }
  ...
  "Partial Account Name Match" must {
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(boundForm, "James", NormalMode)(request, appConfig(), messages(application)).toString
      }
    }
