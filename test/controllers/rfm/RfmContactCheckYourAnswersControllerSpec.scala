  ...
  "Check Your Answers Controller" must {
    ...
    "return OK and the correct view if an answer is provided to every New RFM ID journey questions - Upe" in {
      ...
      running(application) {
        ...
        contentAsString(result) must include("can we contact the primary contact by telephone")
        contentAsString(result) must include("the telephone number for the primary contact")
        ...
        contentAsString(result) must include("can we contact the secondary contact by telephone")
        contentAsString(result) must include("the telephone number for the secondary contact")
