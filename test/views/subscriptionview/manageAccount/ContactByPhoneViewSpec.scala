...
class ContactByPhoneViewSpec extends ViewSpecBase with StringGenerators {
  ...
  lazy val formProvider: ContactByPhoneFormProvider = new ContactByPhoneFormProvider
  lazy val mode:         Mode                       = NormalMode
  lazy val page:         ContactByPhoneView         = inject[ContactByPhoneView]
  lazy val pageTitle:    String                     = "Can we contact by phone"
  lazy val contactName:  String                     = "John Doe"

  "ContactByPhoneView" when {
