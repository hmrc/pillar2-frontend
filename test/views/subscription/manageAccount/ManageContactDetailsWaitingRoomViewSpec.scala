...
import models.subscription.ManageContactDetailsStatus.SuccessfullyCompleted
...
class ManageContactDetailsWaitingRoomViewSpec extends ViewSpecBase {
  ...
  "Manage Contact Details Waiting Room View" should {
    ...
    "have a title" in {
      view.getElementsByTag("title").text must include(messages("Submitting your contact details"))
    }

    "have a heading" in {
      view.getElementsByTag("h1").text must include(messages("Submitting your contact details"))
    }
