...
class RepaymentsCheckYourAnswersViewSpec extends ViewSpecBase {
  ...
  "Repayments Check Your Answers View" should {
    "have a title" in {
      view.title() mustBe "Check your answers before submitting your refund request - Report Pillar 2 Top-up Taxes - GOV.UK"
    }

    "have a unique H1 heading" in {
      val h1Elements: Elements = view.getElementsByTag("h1")
      h1Elements.size() mustBe 1
      h1Elements.text() mustBe "Check your answers before submitting your refund request"
    }
