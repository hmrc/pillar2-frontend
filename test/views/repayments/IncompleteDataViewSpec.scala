...
class IncompleteDataViewSpec extends ViewSpecBase {
  ...
  "Repayments incomplete data view" should {
    "have a title" in {
      view.title() mustBe "Refund request has missing information - Report Pillar 2 Top-up Taxes - GOV.UK"
    }

    "have a heading" in {
      val h1Elements: Elements = view.getElementsByTag("h1")
      h1Elements.size() mustBe 1
      h1Elements.text() mustBe "Refund request has missing information"
    }
