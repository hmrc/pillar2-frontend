...
class RequestRefundAmountViewSpec extends ViewSpecBase {
  ...
  "Request Refund Amount View" should {
    ...
    "page loaded" should {
      ...
      "have a title" in {
        view.title() mustBe "Enter your requested refund amount in pounds - Report Pillar 2 Top-up Taxes - GOV.UK"
      }

      "have a h1 heading" in {
        val h1Elements: Elements = view.getElementsByTag("h1")
        h1Elements.size() mustBe 1
        h1Elements.text() mustBe "Enter your requested refund amount in pounds"
      }
