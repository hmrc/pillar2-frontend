...
class RepaymentsErrorReturnViewSpec extends ViewSpecBase {
  ...
  "Repayments error return view" should {
    ...
    "have a title" in {
      view.title() mustBe "You cannot return, your refund request is complete - Report Pillar 2 Top-up Taxes - GOV.UK"
    }

    "have a heading" in {
      val h1Elements: Elements = view.getElementsByTag("h1")
      h1Elements.size() mustBe 1
      h1Elements.text() mustBe "You cannot return, your refund request is complete"
    }
